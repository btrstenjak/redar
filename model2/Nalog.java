...
public class Nalog {
	...
	@Column
	private LocalDateTime aktivacija_slanja;
	...
	public long getUrl_dokumenta() {
		return url_dokumenta;
	}



	public void setUrl_dokumenta(long url_dokumenta) {
	...
	public LocalDateTime getAktivacija_slanja() {
		return aktivacija_slanja;
	}



	public void setAktivacija_slanja(LocalDateTime aktivacija_slanja) {
		this.aktivacija_slanja = aktivacija_slanja;
	}
	...
	public String toString() {
		return "Nalog [id_nalog=" + id_nalog + ", id_upravitelj=" + id_upravitelj + ", id_prijava=" + id_prijava
				...
				+ ", potpis=" + potpis + ", pozicija=" + pozicija + ", url_dokumenta=" + url_dokumenta
				+ ", datum_slanja=" + datum_slanja + ", aktivacija_slanja=" + aktivacija_slanja + ", datum_naloga="
