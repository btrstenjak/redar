...
public class Korisnici {
	...
	@Column
	private LocalDateTime updatd_at;
	...
	public LocalDateTime getUpdatd_at() {
		return updatd_at;
	}

	public void setUpdatd_at(LocalDateTime updatd_at) {
	...
	public String toString() {
		return "Korisnici [id_korisnik=" + id_korisnik + ", id_upravitelj=" + id_upravitelj + ", id_grad=" + id_grad
				...
				+ ", aktivacija_datum=" + aktivacija_datum + ", created_at=" + created_at + ", updatd_at=" + updatd_at
				+ "]";
	}
