...
@Entity
@Table(name = "radni_dokument_temp")
public class Radni_dokumenti_temp {
	
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	private long id_predlosak;
	...
	public long getId_predlosak() {
		return id_predlosak;
	}

	public void setId_predlosak(long id_predlosak) {
		this.id_predlosak = id_predlosak;
	}
	...
	public String toString() {
		return "Radni_dokumenti_temp [id_predlosak=" + id_predlosak + ", id_upravitelj=" + id_upravitelj + ", vrsta="
	...
	public boolean equals(Object ob){  
        ...
        if(!(ob instanceof Radni_dokumenti_temp))  
         ...
         return naziv_predloska.equals(((Radni_dokumenti_temp)ob).getId_predlosak()) ;      
     } 
}
